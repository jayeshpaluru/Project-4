            ...
            (response) => {
              ...
              response.on('end', () => {
                ...
                _.forEach(realPhotos, (realPhoto) => {
                  const matches = _.filter(photos, (photoCandidate) => photoCandidate.file_name === realPhoto.file_name
                      || photoCandidate.file_name.endsWith(`/${realPhoto.file_name}`));
                  assert.strictEqual(
                    matches.length,
                    1,
                  ...
                  assert(
                    photo.file_name === realPhoto.file_name
                      || photo.file_name.endsWith(`/${realPhoto.file_name}`),
